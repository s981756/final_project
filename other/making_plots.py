...
def make_plot(element_1, element_2):
    ...
    #labeling and saving plot
    plt.title(f'Glass Identification: {element_1_label} vs {element_2_label}')
    plt.xlabel(f'{element_1_label} composition')
    plt.ylabel(f'{element_2_label} composition')
