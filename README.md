...
I ultimately chose to use Al and Si. This is because the plot looked like it had the most defined groups of each of the glass types, so it would have the most accurate KNN classifier model.
